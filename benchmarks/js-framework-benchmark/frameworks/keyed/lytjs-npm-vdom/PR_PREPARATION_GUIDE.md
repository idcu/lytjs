# LytJS (npm, VDOM) PR Preparation Guide

This guide explains how to prepare and submit the LytJS VDOM mode implementation to js-framework-benchmark.

## Overview

This implementation uses the `@lytjs/core-vnode` package from npm, version 6.9.x, which provides traditional Virtual DOM rendering.
...
git checkout -b add-lytjs-npm-vdom
```

### Step 3: Copy Implementation

```bash
mkdir -p frameworks/keyed/lytjs-npm-vdom
# Copy all files from this directory to frameworks/keyed/lytjs-npm-vdom/
```

### Step 4: Commit and Push

```bash
git add frameworks/keyed/lytjs-npm-vdom
git commit -m "Add LytJS (npm, VDOM) v6.9.x"
git push origin add-lytjs-npm-vdom
```
...
- ⚡ **Virtual DOM mode** - Traditional diff-based rendering
- 📦 **Small bundle size**
- 🔧 **TypeScript support**

### Implementation Details

This implementation uses the `@lytjs/core-vnode` npm package (v6.9.x) which provides the Virtual DOM rendering mode.
