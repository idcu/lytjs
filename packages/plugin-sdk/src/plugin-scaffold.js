...
// ============================================================
/** package.json 模板 */
function packageJsonTemplate(options) {
...
/** lyt-plugin.json 模板 */
function pluginManifestTemplate(options) {
    const fullName = normalizePluginName(options.name);
    return JSON.stringify({
        name: fullName,
        version: options.version || '1.0.0',
...
/** 根据模板类型获取默认权限 */
function getPermissionsForTemplate(template) {
    switch (template) {
        case 'ui':
            return ['theme'];
        case 'tool':
...
//# sourceMappingURL=plugin-scaffold.js.map