...
export class SourceMapGenerator {
  ...
  addMapping(
    ...
    const finalOriginalColumn =
      originalColumnExact !== undefined ? originalColumnExact : originalColumn;
  ...
  private encodeMappings(): string {
    ...
    for (const mapping of sorted) {
      ...
      let segment =
        vlqEncode(genCol) + vlqEncode(source) + vlqEncode(origLine) + vlqEncode(origCol);
