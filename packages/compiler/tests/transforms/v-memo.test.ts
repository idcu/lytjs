...
describe('transformVMemo', () => {
  ...
  describe('缓存变量名生成', () => {
    it('应该为每个 v-memo 元素生成唯一的缓存变量名', () => {
      ...
      const memoDir1 = createDirective(
        'memo',
        undefined,
        createSimpleExpression('[a]', false),
      );
  ...
  describe('边界条件', () => {
    ...
    it('应该处理组件类型的 v-memo 元素', () => {
      ...
      const memoDir = createDirective(
        'memo',
        undefined,
        createSimpleExpression('[props]', false),
      );
    ...
    it('应该处理带有属性的 v-memo 元素', () => {
      ...
      const memoDir = createDirective(
        'memo',
        undefined,
        createSimpleExpression('[id]', false),
      );
      const element = createElement(
        'div',
        [memoDir, createAttr('id', 'app'), createAttr('class', 'container')],
      );
  ...
  describe('不同依赖表达式', () => {
    it('应该处理单元素依赖数组', () => {
      ...
      const memoDir = createDirective(
        'memo',
        undefined,
        createSimpleExpression('[x]', false),
      );
      const element = createElement('div', [memoDir]);
