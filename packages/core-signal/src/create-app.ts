...
import type { App, AppOptions, Plugin, Component, ComponentPublicInstance } from './types';
  ...
  const context = {
    ...
    config: {
      errorHandler: undefined as
        | ((err: unknown, instance: unknown, info: string) => boolean | void)
        | undefined,
