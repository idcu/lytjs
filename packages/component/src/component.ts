...
// component-init.ts: 组件完成初始化
export { finishComponentSetup } from './component-init';
...
// component-inject.ts: 依赖注入
export type { InjectionKey, ProvideOptions, InjectOptions } from './component-inject';
export { provide, inject } from './component-inject';
