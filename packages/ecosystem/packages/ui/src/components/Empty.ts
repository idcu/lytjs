  ...
  setup(props: Record<string, unknown>, { slots }: { slots: EmptySlots }) {
    ...
    return () => {
      ...
      if (slots.image) {
        ...
        children.push(
          createVNode('div', { class: 'lyt-empty__image' }, [
            createVNode('img', {
              src: p.image,
              alt: 'empty',
          ...
          createVNode('div', { class: 'lyt-empty__image' }, [
            createVNode(
              'svg',
              {
                ...
                style: {
                  width: `${p.imageSize || 160}px`,
                  height: `${(p.imageSize || 160) * 0.8}px`,
                },
              },
              [
                createVNode('g', { fill: 'none', 'fill-rule': 'evenodd' }, [
                  createVNode('g', { transform: 'translate(40 40)' }, [
                    ...
                    createVNode('path', {
                      d: 'M160 0C71.6 0 0 62.7 0 140s71.6 140 160 140 160-62.7 160-140S248.4 0 160 0z',
                      fill: 'var(--lyt-color-info)',
                      opacity: '0.15',
                    }),
                    createVNode('g', { fill: 'var(--lyt-color-info)' }, [
                      createVNode('path', {
                        d: 'M184 104a8 8 0 0 1 8 8v24a8 8 0 0 1-16 0v-24a8 8 0 0 1 8-8z',
                        opacity: '0.3',
                      }),
                      createVNode('path', {
                        d: 'M128 104a8 8 0 0 1 8 8v24a8 8 0 0 1-16 0v-24a8 8 0 0 1 8-8z',
                        opacity: '0.3',
                      }),
                      createVNode('path', {
                        d: 'M216 184H104a8 8 0 0 1-8-8v-16a8 8 0 0 1 8-8h112a8 8 0 0 1 8 8v16a8 8 0 0 1-8 8z',
                        opacity: '0.2',
                      }),
                    ]),
                  ]),
      ...
      if (slots.description) {
        ...
        children.push(
          createVNode('div', { class: 'lyt-empty__description' }, [createTextVNode(p.description)]),
        );
      }
