...
describe("@lytjs/common-error", () => {
  ...
  describe("getCategory", () => {
    it("should return compiler category for compiler codes", () => {
      expect(getCategory(LytErrorCodes.INVALID_EXPRESSION)).toBe(
        ErrorCategory.COMPILER,
      );
    });

    it("should return renderer category for renderer codes", () => {
      expect(getCategory(LytErrorCodes.RENDER_ERROR)).toBe(
        ErrorCategory.RENDERER,
      );
    });

    it("should return component category for component codes", () => {
      expect(getCategory(LytErrorCodes.INVALID_PROP_TYPE)).toBe(
