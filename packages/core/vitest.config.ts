...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      {
        find: '@lytjs/common-dom-helpers',
        replacement: `${commonRoot}/dom-helpers/dist/index.mjs`,
      },
      ...
      {
        find: '@lytjs/common-performance',
        replacement: `${commonRoot}/performance/dist/index.mjs`,
      },
      {
        find: '@lytjs/common-render-queue',
        replacement: `${commonRoot}/render-queue/dist/index.mjs`,
      },
      ...
      {
        find: '@lytjs/common-event-normalizer',
        replacement: `${commonRoot}/event-normalizer/dist/index.mjs`,
      },
      {
        find: '@lytjs/common-async-scheduler',
        replacement: `${commonRoot}/async-scheduler/dist/index.mjs`,
      },
      {
        find: '@lytjs/common-transition-engine',
        replacement: `${commonRoot}/transition-engine/dist/index.mjs`,
      },
      // 主包
      ...
      { find: '@lytjs/vdom', replacement: resolve(packagesRoot, 'vdom/dist/index.mjs') },
      {
        ...
        replacement: resolve(packagesRoot, 'reactivity/dist/index.mjs'),
      },
      {
        find: /^@lytjs\/reactivity\/scope$/,
        replacement: resolve(packagesRoot, 'reactivity/dist/scope.mjs'),
      },
      {
        find: /^@lytjs\/reactivity\/async$/,
        replacement: resolve(packagesRoot, 'reactivity/dist/async.mjs'),
      },
      ...
      {
        find: '@lytjs/config',
        replacement: resolve(packagesRoot, 'ecosystem/packages/config/dist/index.mjs'),
      },
