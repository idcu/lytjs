...
const IGNORE_DIRS = ['node_modules', 'dist', 'lib', 'coverage', '.git', '.trae', 'e2e', 'playground'];
...
const testBatches = [
  ...
  { name: 'core packages', packages: ['packages/core', 'packages/core-signal', 'packages/core-vnode'] },
